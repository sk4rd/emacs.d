...
* Table of Contents (use-package org-roam
   :ensure t
   :after org
   :init
...
* Installation
This section details various methods to install and set up this Emacs
configuration, catering to different preferences - automatic, manual,
or directly using the org file.
